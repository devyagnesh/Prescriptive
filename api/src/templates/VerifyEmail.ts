...
const verifyEmail = function (code: number): IEmailVerify {
  const html = `
    ...
    <body
      ...
      <div style="display: none;">  A request to create your <b>Prescriptive</b> account was received.
                      ...
                      <tr>
                        <td class="sm-px-24"
                          style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                           align="left">
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Verify Email Address</p>

                          <p style="margin: 0 0 24px;">
                            A request to create your <b>Prescriptive</b> account was received.
Use this link to confirm your account and log in
                          ...
                          <p style="margin: 0 0 16px;">
                            ...
                            <a href="mailto:chiragmehta900@gmail.com" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">info@keplersoft.in</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Thanks, <br>Prescriptive Team</p>
                        </td>
                      </tr>
                      <tr>
  ...
  const text = `
        Verify Email, A request to create your <b>Prescriptive</b> account was received.
        Use this link to confirm your account and log in`
  return {
    html,
    text
